export default function Personel(req,res) {
    let personel = {
        name: "Taner Saydam",
        subTitle: "Welcome my blog page",
        logo: "logo.jpg",
        aboutMe: `
        <p>
